...
final class TenantUpsertCommand extends Command
{
    protected static $defaultName = 'tenant:upsert';
    protected static $defaultDescription = 'Create or update a tenant';
    ...
    {
        $this
            ->addOption('id', null, InputOption::VALUE_REQUIRED, 'Tenant id (if set, update)')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // CREATE
        if ($idOpt === null) {
            $id = $this->tenants->create($fullName, $email, $address);
            $output->writeln("<info>Created tenant #{$id}</info>");
